...
async function main () {
  ...
  const deployedAddress = await deployUpgradableContract(hre, deployHelpers.chainId, "TokenTreat", deployHelpers.payDeployer, [owner, owner])

  await verifyUpgradableContract(hre, 'contracts/TokenTreat.sol:TokenTreat', deployedAddress, '84532')
}
