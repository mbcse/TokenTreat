...
const Header: FC = () => {
  ...
  return (
    ...
    >
      ...
      <HStack>
        <Button colorScheme='purple'><Link href="/my-treat-dashboard/treat-burn-marketplace"> Treat Burn Marketplace</Link></Button>
        <Button colorScheme='green'><Link href="/my-treat-dashboard/my-treats"> Dashboard </Link></Button>
        <ConnectButton />
